...
// Standart değerler.
DEFAULT.ACTION_COLOR = "#689BD2";
DEFAULT.ACTION2_COLOR = "cadetblue";
...
DEFAULT.BUTTON_COLOR = DEFAULT.ACTION_COLOR
DEFAULT.BUTTON_TEXT_COLOR = "rgba(0, 0, 0, 0.65)";
...
basic_settings.show_hidden_objects_xms_later = 10; // 15
// Oluşturulan nesneler kaç ms sonra görünsün.
basic_settings.auto_size_calculated_xms_later = 20; // 30 - 30 olursa, daire app metinler titreme yapıyor. 17 titreme olmuyor.
// Hareketi ayarlar
basic_settings.set_motion_xms_later = 30; // 20
// Hareket et
basic_settings.with_motion_xms_later = 40; // 30
...
class UIComponent {
    ...
    get width() {
        ...
        if (isNaN(_width)) {
            if(this.contElement.style.visibility != "visible") {
                ...
                print("BASICJS: Otomatik gelişlik henüz hesaplanmadı. Lütfen, afterCalc(func) fonksiyonunu kullanın.");
            } else {
    ...
    get height() {
        ...
        if (isNaN(_height)) {
            if(this.contElement.style.visibility != "visible") {
                ...
                print("BASICJS: Otomatik yükseklik henüz hesaplanmadı. Lütfen, afterCalc(func) fonksiyonunu kullanın.");
            } else {
                _height = parseInt(this.contElement.offsetHeight);
            }
        }
    ...
    set visible($value) {
        this._visible = $value;
        // Nesne olluşturulduktan sonra, görünür olana kadar display değiştirilemez.
        // Böylece tarayıcı, "auto" için hesaplamaları yapabilir.
        if(this.contElement.style.visibility == "visible") {
    ...
    setMotion($motionString) {
        ...
        }, basic_settings.set_motion_xms_later);
    }
    ...
    withMotion($func) {
        ...
        setTimeout(function() {
            $func(_that);
        }, basic_settings.with_motion_xms_later)
    }
    ...
    breakMotion() {
        ...
        setTimeout(function(){
            _that.contElement.style.transition = _that._motionString;
        }, basic_settings.break_motion_time)
    }
}
...
class Button extends UIComponent {
    ...
    constructor($left = 0, $top = 0, $width = DEFAULT.BUTTON_WIDTH, $height = DEFAULT.BUTTON_HEIGHT) {
        ...
        // Text
        this._fontSize = 20;
        this._textColor = DEFAULT.BUTTON_TEXT_COLOR;
...
let basic_visibiltyControl = function ($object) {
    ...
    basic_hiddenControlTimer = setTimeout(function () {
        ...
        for ( var i = 0; i < basic_hiddenObjects.length; i++) {
            ...
            // Nesne gösterildiğinde, istenen değere göre; nesneyi göster veya gösterme.
            basic_hiddenObjects[i].contElement.style.display = (basic_hiddenObjects[i]._visible == 1) ? "block" : "none";
        }
...
let afterCalc = function($func, $obj) {

    // Otomatik yükseklik henüz hesaplanmadı. Lütfen, afterCalc(func) fonksiyonunu kullanın.

    setTimeout(function(){
        $func($obj)
    }, basic_settings.auto_size_calculated_xms_later);
